...
<body>
    ...
    <nav class="navbar navbar-dark navbar-expand-lg bg-dark" style="position: sticky; top: 0;">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-auto">
            ...
            <!-- Servicio -->
            <li class="nav-item">
            <a class="nav-link active" href="servicio.php">Servicio</a>
            </li>
            <!-- Contacto -->
            <li class="nav-item">
    ...
    <footer class="container-fluid bg-dark text-light">
        <section class="row footer-servicios py-4">
            <article class="col-sm-8 container text-center py-2">
                <h5>Nosotros</h5>
                <h6 class="fw-light px-4">
            ...
            <article class="col-sm-4 container text-center pb-3">
